...
function NewsLetter() {
  ...
  return (
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row items-center text-white w-full'>
          ...
          <div className='flex-1 flex flex-col w-full  gap-[22px]'>
              ...
              <button className='bg-primary hover:bg-slate-900 h-[60px] border-0 outline-0 rounded-lg font-medium text-xl transition'>ارسال نظر</button>
          </div>
      </div>
    </div>
    </section>
